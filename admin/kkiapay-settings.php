...
return array(
    ...
    'exchangerate_api_key' => array(
        'title' => __('ExchangeRate-API Key', 'kkiapay-woocommerce'),
        'type' => 'password',
        'desc_tip' => true,
        'description' => __('Get your API key from https://www.exchangerate-api.com (required for USD to XOF conversion)', 'kkiapay-woocommerce')
    ),
    // 'refund' => array(
